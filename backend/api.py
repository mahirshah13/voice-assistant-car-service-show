...
class AssistantFnc(llm.FunctionContext):
    def __init__(self):
        ...
        # store come context about the car, so the LLM has context/information
    ...
    # this will be read by a model whether to use a function or not
    ...
    def create_car(
        ...
        make: Annotated[str, llm.TypeInfo(description="The make of the car to lookup")], 
        model: Annotated[str, llm.TypeInfo(description="The model of the car to lookup")], 
        year: Annotated[int, llm.TypeInfo(description="The year of the car to lookup")]
    ):
